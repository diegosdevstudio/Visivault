...
2. Accept the **Privacy & Consent Modal** (required for Gemini Free Tier).
...
3. Gemini will return a prompt rich with:
...
4. **Pro Mode:** Toggle enhancer tags (8k, raw photo, film grain…) and add Negative Prompts, then click **⚡ Build Final Prompt** for a complete, copy-ready generation string.
...
3. Receive 5 structured scenes:
   - Scene 1: The Hook
   - Scene 2: The Build
   - Scene 3: The Turn
   - Scene 4: The Climax
   - Scene 5: The Resolution
4. Each scene is camera-direction ready for Sora, Runway, or Pika Labs.
